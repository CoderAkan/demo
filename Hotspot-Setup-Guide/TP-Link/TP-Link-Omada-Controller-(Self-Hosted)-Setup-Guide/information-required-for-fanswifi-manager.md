...
![(2) Login.png](../../../_images/information-required-for-fanswifi-manager-196.png)
...
![](../../../_images/information-required-for-fanswifi-manager-197.png)
...
![](../../../_images/information-required-for-fanswifi-manager-198.png)
...
## Step 7: Get the MAC address of the AP (Will be used onStep 10)
...
![(7) Click "Device".png](../../../_images/information-required-for-fanswifi-manager-199.png)

![(7) Device MAC Address.png](../../../_images/information-required-for-fanswifi-manager-200.png)
...
![](../../../_images/information-required-for-fanswifi-manager-201.png)

- b. Select "Operators" on the left menu, then click "Create Operator"

![](../../../_images/information-required-for-fanswifi-manager-202.png)
...
![](../../../_images/information-required-for-fanswifi-manager-203.png)

## Step 9: Get the Domain, Port and ID of controller (Will be used onStep 11)

- You can obtain the domain, Port and controller ID through the website URL on Hotspot Manager section

![](../../../_images/information-required-for-fanswifi-manager-204.png)
...
![](../../../_images/information-required-for-fanswifi-manager-205.png)
...
- **Admin Username:** <your-admin-id> (Hotspot Operator Username configured in[Step 8]([#h_f10005627f](https://www.facebook.com/hashtag/h_f10005627f)), i.e. FansWiFiAPI)
- **Admin Password:** <your-admin-password> (Hotspot Operator Password configured in[Step 8]([#h_f10005627f](https://www.facebook.com/hashtag/h_f10005627f)))
- e. Click "Save"

![(9b) Controller Setting.png](../../../_images/information-required-for-fanswifi-manager-206.png)
