...
6. Open the **Advanced** tab.
   ...
   ![](../../../_images/cisco_step_7_6.png)

   3. **(Optional) FlexConnect Mode:**
      - **FlexConnect Local Switching:** Enabled

      ![](../../../_images/cisco_step_7_7.png)
