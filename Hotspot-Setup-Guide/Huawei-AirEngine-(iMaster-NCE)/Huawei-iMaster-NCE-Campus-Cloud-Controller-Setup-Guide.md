...
1. Configure with the following settings:
    ...
    1. **SSID name:** <SSID-name-you-prefer> (e.g. - FansWiFi Free WiFi -)
...
5. Access Control Configuration
    ...
    ![](../../../_images/huawei_imaster_5.png)

    ![](../../../_images/huawei_imaster_6.png)
...
![](../../../_images/information-required-for-fanswifi-manager-306.png)
