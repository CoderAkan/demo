...
![Omada login page](../../.gitbook/assets/information-required-for-fanswifi-manager-227.png)
...
![Omada settings menu](../../.gitbook/assets/information-required-for-fanswifi-manager-228.png)

6. Click **Create New Wireless Network**.

![Create new wireless network](../../.gitbook/assets/information-required-for-fanswifi-manager-229.png)
...
![WLAN configuration details](../../.gitbook/assets/information-required-for-fanswifi-manager-230.png)
...
![Portal settings](../../.gitbook/assets/information-required-for-fanswifi-manager-231.png)

3. Click **Create New Portal**.

![Create new portal](../../.gitbook/assets/information-required-for-fanswifi-manager-232.png)
...
![Portal configuration details](../../.gitbook/assets/information-required-for-fanswifi-manager-233.png)

#### Step 5: Access Control Settings

1. Click **Access Control** on the top menu.

![Access control menu](../../.gitbook/assets/information-required-for-fanswifi-manager-234.png)
...
![Pre-authentication access configuration](../../.gitbook/assets/information-required-for-fanswifi-manager-235.png)
...
![Create RADIUS profile](../../.gitbook/assets/information-required-for-fanswifi-manager-236.png)
...
![RADIUS profile details](../../.gitbook/assets/information-required-for-fanswifi-manager-237.png)
...
![Final MAC-based authentication settings](../../.gitbook/assets/information-required-for-fanswifi-manager-238.png)

#### Step 7: Get the MAC address of the AP (Will be used in [Step 10](tp-link-omada-controller-cloud-based-setup-guide.md#step-10))
...
![Devices list in Omada](../../.gitbook/assets/information-required-for-fanswifi-manager-239.png)

#### Step 8: Add FansWiFiAPI Admin account for API call by FansWiFi Portal Server (Will be used in [Step 11](tp-link-omada-controller-cloud-based-setup-guide.md#step-11))

1. Click **Hotspot** on the left menu.

![Hotspot menu](../../.gitbook/assets/information-required-for-fanswifi-manager-240.png)

2. Select **Operators** and click **Create Operator**.

![Operators list](../../.gitbook/assets/information-required-for-fanswifi-manager-241.png)
...
![Operator creation details](../../.gitbook/assets/information-required-for-fanswifi-manager-242.png)

#### Step 9: Get the Domain and ID of controller (Will be used on [Step 11](tp-link-omada-controller-cloud-based-setup-guide.md#step-11))

You can find the domain and controller ID in the browser URL when viewing the Hotspot section.

![Controller URL inspection](../../.gitbook/assets/information-required-for-fanswifi-manager-243.png)

#### Step 10: Add AP to FansWiFi Admin Panel

1. Log in to the FansWiFi Admin Panel.

![](../../.gitbook/assets/tp_0.png)
...
![Hotspot creation in FansWiFi](../../.gitbook/assets/information-required-for-fanswifi-manager-244.png)
...
![](../../.gitbook/assets/tp_1.png)

3. Click **Controllers**.
4. Configure the following:
   * **TP-Link Omada Controller IP or URL:** `https://<your-controller-url>`
   * **Port Number:** 443 (or your configured port)
   * **Admin Username:** (The operator username from [Step 8](tp-link-omada-controller-cloud-based-setup-guide.md#step-8))
   * **Admin Password:** (The operator password from [Step 8](tp-link-omada-controller-cloud-based-setup-guide.md#step-8))
5. Click **Save**.

![Controller configuration in FansWiFi](../../.gitbook/assets/information-required-for-fanswifi-manager-245.png)
