...
![](../../.gitbook/assets/aerohive-ng-conf-0.png)

3. Name the policy. ![](../../.gitbook/assets/aerohive-ng-conf-1.png)
...
2.  Configure:
    ...
    * If this is your first time setup, add a new **Default Captive Web Portal**
    ...
    ![](../../.gitbook/assets/information-required-for-fanswifi-manager-19.png)
...
![](../../.gitbook/assets/aerohive-ng-conf-2.png)
...
3.  Configure **Login Page**
    ...
    * **Failure Page:** OFF
    ...
    ![](../../.gitbook/assets/information-required-for-fanswifi-manager-20.png)
...
1.  Go to **Walled Garden** and add new rules.
    ...
    ![](../../.gitbook/assets/information-required-for-fanswifi-manager-21.png)
...
![](../../.gitbook/assets/information-required-for-fanswifi-manager-22.png)
...
1.  Add a new **RADIUS Server Group**
    ...
    ![](../../.gitbook/assets/information-required-for-fanswifi-manager-23.png)
2.  In the RADIUS Server Group, add a new **External RADIUS Server**

    ![](../../.gitbook/assets/aerohive-ng-conf-3.png)
3.  Configure the external RADIUS server:

    * **Name:** FansWiFi Radius
    *   **Host Name:** `radius.fanswifi.com`

        ![](../../.gitbook/assets/aerohive-ng-conf-4.png)
    * **Authentication Port:** `1812`
    * **Accounting Port:** `1813`
    * **Shared Secret:** `social123`

    ![](../../.gitbook/assets/information-required-for-fanswifi-manager-24.png)
...
1.  Click **Save** to save the SSID settings.
    ...
    ![](../../.gitbook/assets/information-required-for-fanswifi-manager-25.png)
...
4.  Click **Perform Update**
    ...
    ![](../../.gitbook/assets/information-required-for-fanswifi-manager-26.png)

    ![](../../.gitbook/assets/information-required-for-fanswifi-manager-27.png)
...
![](../../.gitbook/assets/information-required-for-fanswifi-manager-28.png)
...
| ---------------------------- | ------------------------------------------------------------------------ | --------------------------------------------------------------------------------------- |
|                              | <p>Not available<br><br>Last Testing: 11-9-2017<br><br>HiveOS: 8.1r1</p> | <p>Not available in HiveManager<br><br>Last Testing: 11-9-2017<br><br>HiveOS: 8.1r1</p> |
