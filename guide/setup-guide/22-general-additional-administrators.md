...
![](../../.gitbook/assets/22-general-additional-administrators-375.png)

`For new users, the administrator needs to create an account:`

![](../../.gitbook/assets/22-general-additional-administrators-376.png)
...
![](../../.gitbook/assets/22-general-additional-administrators-377.png)

`When confirming a new user’s account, the administrator will be able to set its permissions:`

![](../../.gitbook/assets/22-general-additional-administrators-378.png)
...
![](../../.gitbook/assets/22-general-additional-administrators-379.png)
...
![](../../.gitbook/assets/22-general-additional-administrators-380.png)

`For existing users, the administrator needs to add their account to the organization:`

![](../../.gitbook/assets/22-general-additional-administrators-381.png)
