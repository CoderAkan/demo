---
description: >-
  After configuring the WiFi Captive portal, but the AP does not redirect WiFi
...
#### _Please record your screen while performing the tests and share the recording with our support team for further troubleshooting. Screen recordings are invaluable in helping us observe and understand the issue more effectively._

#### _If the screen recording file is too large, we suggest uploading it to YouTube as an unlisted video. Unlisted videos are private and will not be visible to others unless they have the link. You can then share the link with us, and we’ll review it. Thank you for your cooperation._
...
![](../../../.gitbook/assets/1-test-if-the-wifi-user-able-to-access-the-internet-307.png)
...
![](../../../.gitbook/assets/1-test-if-the-wifi-user-able-to-access-the-internet-308.png)
...
![](../../../.gitbook/assets/1-test-if-the-wifi-user-able-to-access-the-internet-309.png)
...
![](../../../.gitbook/assets/1-test-if-the-wifi-user-able-to-access-the-internet-310.png)
...
![](../../../.gitbook/assets/1-test-if-the-wifi-user-able-to-access-the-internet-311.png)
...
![](../../../.gitbook/assets/1-test-if-the-wifi-user-able-to-access-the-internet-312.png)
