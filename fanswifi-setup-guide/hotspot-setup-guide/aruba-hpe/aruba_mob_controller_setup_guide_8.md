  ...
  * Make sure your controller have a "Default Gateway" setting if not available
    ...
    *   Goto Configuration > Interface > IP route
        ...
        * Click "**+**" under **Static** >**Default Gateway**
        ...
        ![](../../../.gitbook/assets/aruba_ping_version_8_res_2.png)
...
*   c. In **General** setting
    ...
    * Click "**Next**"
    ...
    ![](../../../.gitbook/assets/aruba_mob_control_8_section_d.png)
*   d. In **VLANs** setting
    ...
    * VLAN: **1 (or any vlan you use)**
      ...
      * Please refer to FAQ for more details
        * [FAQ 2). If VLAN is used in your setup, make sure the controller have an Interface and IP Address on this VLAN](../../../Hotspot-Setup-Guide/Aruba-\(HPE\)/\[/#h_6d97a36cda]\(https://www.facebook.com/hashtag/h_6d97a36cda\))
    * Click "**Next**"

    ![](../../../.gitbook/assets/aruba_mob_control_8_section_e.png)
*   e. In **Security** setting

    ![](../../../.gitbook/assets/aruba_mob_control_section_f.png)
    ...
    *   In **Auth servers,** Click "**+**" > "**+**" (Create new server)
        ...
        * Click "**Submit**"
        ...
        ![](../../../.gitbook/assets/aruba_mob_control_8_section_f_2.png)
    * Then, configure with following settings:
      * Auth servers: **FansWiFi\_Radius**
    ...
    * Click "**Next**"
    ...
    ![](../../../.gitbook/assets/aruba_mob_control_8_section_f_3.png)
...
* c. Configure the settings with below settings
  * i. IP Version: **IPv4**
  * ii. Name: **FansWiFi\_WalledGarden**
...
![](../../../.gitbook/assets/setting-on-aruba-controller-313.png)
...
![](../../../.gitbook/assets/setting-on-aruba-controller-314.png)
...
* c. Select **- FansWiFi Free WiFi -\_cppm\_prof**
  * a profile will be created automatically by the controller for each SSID you created **\_cppm\_prof** in [**Step 1**](aruba_mob_controller_setup_guide_8.md#step-1-configuration-wlan-and-ssid)
* add configure with below settings
  ...
  * xvii. White List: Add **FansWiFi\_WalledGarden** from the list (by clicking **"+"**)
    * **FansWiFi\_WalledGarden was defined in** [**Step 2**](aruba_mob_controller_setup_guide_8.md#step-2-configuration-walled-garden)
    * **- FansWiFi Free WiFi -\_cppm\_prof** should remain in allow list
...
![](../../../.gitbook/assets/setting-on-aruba-controller-315.png)

#### Step 4: Configuration: AAA profile

* a. Click **Configuration > Authentication > AAA profiles**
* b. Select **AAA**
* c. Select **- FansWiFi Free WiFi -\_aaa\_prof**
  * a profile will be created automatically by the controller for each SSID you created **\_aaa\_prof** in [**Step 1**](aruba_mob_controller_setup_guide_8.md#step-1-configuration-wlan-and-ssid)
...
![](../../../.gitbook/assets/aruba_mob_control_8_step_4.png)

#### Step 5: Configuration: Radius Server

* a. Click **Configuration > Authentication > Auth servers**
* b. From **all server**, select **FansWiFi\_rad1**
...
![](../../../.gitbook/assets/aruba_mob_control_8_step_5.png)

#### Step 6: Add AP to FansWiFi Admin Panel

* Login to FansWiFi Admin Panel

![](../../../.gitbook/assets/aruba_mob_control_8_step_6_1.png)
...
![](../../../.gitbook/assets/setting-on-aruba-controller-316.png)
...
| WiFi User Logout trigger by: | <p>WiFi User's Device<br>(usually, access a logout url on browser)</p> | Controller Web Admin Interface            | Conductor Web Admin Interface         |
| ---------------------------- | ---------------------------------------------------------------------- | ----------------------------------------- | ------------------------------------- |
|                              | <p>No Information<br><br>Last Testing:</p>                             | <p>Not available<br><br>Last Testing:</p> | <p>Available<br><br>Last Testing:</p> |
...
![](../../../.gitbook/assets/setting-on-aruba-controller-317.jpeg)
...
![](../../../.gitbook/assets/setting-on-aruba-controller-318.png)
