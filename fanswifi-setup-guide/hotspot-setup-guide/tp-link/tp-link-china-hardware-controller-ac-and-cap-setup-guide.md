...
*   Access Point
    ...
    * Firmware Version: 1.1.8
    ...
    ![](../../../.gitbook/assets/tp_china_1.png)

### Network Topology

![](../../../.gitbook/assets/information-required-for-fanswifi-manager-246.png)
...
![](../../../.gitbook/assets/information-required-for-fanswifi-manager-247.png)

* c. Configure with following settings:
  * **SSID:** - FansWiFi Free WiFi -
* d. Click "确定"

![](../../../.gitbook/assets/information-required-for-fanswifi-manager-248.png)

* e. Click "确定"

![](../../../.gitbook/assets/information-required-for-fanswifi-manager-249.png)
...
![](../../../.gitbook/assets/information-required-for-fanswifi-manager-250.png)
...
![](../../../.gitbook/assets/information-required-for-fanswifi-manager-251.png)
...
![](../../../.gitbook/assets/information-required-for-fanswifi-manager-252.png)

* d. Configure with following settings:
  * **生效SSID:** - FansWiFi Free WiFi -
  * **认证成功跳转链接:** [http://connect-p.fanswifi.com/auth?res=success\&ap\_type=tp-link-ac](http://connect-p.fanswifi.com/auth?res=success\&ap_type=tp-link-ac)
  * **认证失败跳转链接:** [http://connect-p.fanswifi.com/auth?res=failed\&ap\_type=tp-link-ac](http://connect-p.fanswifi.com/auth?res=failed\&ap_type=tp-link-ac)
  * **远程Portal地址:** [http://connect-p.fanswifi.com/auth](http://connect-p.fanswifi.com/auth)
  * **认证服务器类型:** 远程服务器
  * **认证服务器组:** FansWiFi\_Auth\_Radius
* e. Click "确定"

![](../../../.gitbook/assets/information-required-for-fanswifi-manager-253.png)
...
![](../../../.gitbook/assets/information-required-for-fanswifi-manager-254.png)
...
![](../../../.gitbook/assets/information-required-for-fanswifi-manager-255.png)
...
![](../../../.gitbook/assets/information-required-for-fanswifi-manager-256.png)

**Step 7: Add AP to FansWiFi Admin Panel**

* Login to FansWiFi Admin Panel

![(8a) Create.png](../../../.gitbook/assets/information-required-for-fanswifi-manager-257.png)
...
![](../../../.gitbook/assets/information-required-for-fanswifi-manager-258.png)
