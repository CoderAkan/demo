...
![Network Topology](../../../.gitbook/assets/information-required-for-fanswifi-manager-151.png)
...
![SmartZone authentication settings](../../../.gitbook/assets/information-required-for-fanswifi-manager-152.png)

### Step 2: Configuration: Authentication (RADIUS) Server

![Full authentication server view](../../../.gitbook/assets/information-required-for-fanswifi-manager-153.png)
...
![RADIUS authentication configuration](../../../.gitbook/assets/information-required-for-fanswifi-manager-154.png)

### Step 3: Configuration: Accounting (RADIUS) Server

![Full accounting server view](../../../.gitbook/assets/information-required-for-fanswifi-manager-155.png)
...
![RADIUS accounting configuration](../../../.gitbook/assets/information-required-for-fanswifi-manager-156.png)

### Step 4: Configure AP Zone and Hotspot Service

1. Select **Access Points** from the left menu.

![Access points list](../../../.gitbook/assets/information-required-for-fanswifi-manager-157.png)
...
![Hotspot services menu](../../../.gitbook/assets/information-required-for-fanswifi-manager-158.png)
...
4.  Configure the following:
    ...
    * **Grace Period:** 60
    ...
    ![](../../../.gitbook/assets/ruckus_smart_zone_3.5_0.png)

#### Walled Garden Settings

{% hint style="info" %}
1. You may download the walled garden list .csv files on\
   https://cdn.fanswifi.com/assets/ruckus/fanswifi\_ruckus\_smartzone\_walled\_garden.zip
...
![](../../../.gitbook/assets/ruckus_smart_zone_3.5_1.png)

### Step 5: Create WLAN and SSID

![Wireless LANs menu](../../../.gitbook/assets/information-required-for-fanswifi-manager-159.png)
...
![WLAN configuration view 1](../../../.gitbook/assets/information-required-for-fanswifi-manager-160.png)

![WLAN configuration view 2](../../../.gitbook/assets/information-required-for-fanswifi-manager-161.png)

3. Under **Advanced Options**:
   * **Inactivity Timeout:** 1000 seconds
   * **Bypass CNA:** Disabled

![WLAN configuration view 3](../../../.gitbook/assets/information-required-for-fanswifi-manager-162.png)

![WLAN configuration view 4](../../../.gitbook/assets/information-required-for-fanswifi-manager-163.png)
...
![Northbound Interface settings](../../../.gitbook/assets/information-required-for-fanswifi-manager-164.png)
...
![Admin panel venue list](../../../.gitbook/assets/information-required-for-fanswifi-manager-165.png)
...
![Controller configuration details](../../../.gitbook/assets/information-required-for-fanswifi-manager-166.png)
...
![](../../../.gitbook/assets/ruckus_3.5_2.png)
